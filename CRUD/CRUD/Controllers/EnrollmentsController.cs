...
namespace CRUD.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        public EnrollmentsController(StudentmanagementsysContext context)
        {
            _context = context;
        }
        ...
        {
            var studentmanagementsysContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await studentmanagementsysContext.ToListAsync());
        }
